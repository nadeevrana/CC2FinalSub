...
--
-- Table structure for table `discussion_new`
--
...
--
-- Dumping data for table `discussion_new`
--

INSERT INTO `discussion_new` (`id`, `parent_comment`, `student`, `post`, `date`) VALUES
...
--
-- Indexes for table `discussion_new`
--
ALTER TABLE `discussion_new`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `discussion_new`
--
ALTER TABLE `discussion_new`
